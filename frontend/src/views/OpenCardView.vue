<template xmlns:strongEmail="http://www.w3.org/1999/html">
  <div class="page">
    ...
    <div v-if="cardStatus === 'waiting'" class="status-message">
      ...
      <p>⏱️ Очікуйте підтверження адміністратора на вікриття вашої карти карти</p>
    </div>
    ...
    <div v-else-if="cardStatus === null">
      ...
      <p v-if="showPendingMessageAfterSubmit" class="success-message">
        ...
        ⏱️ Очікуйте підтверження адміністратора на вікриття вашої карти карти.
      </p>
    </div>
...
import Cards from '../../../backend/src/constants/cards.js';
